...
export const EmptyResult = () => {
  return (
    <div className="flex flex-col items-center justify-center text-center p-4 w-full h-full gap-3">
      <img src={emptyImg} alt="no results image" />
      <h2 className="font-bold text-white text-2xl">Results shown here</h2>

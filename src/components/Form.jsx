...
export const Form = ({ onSubmit, onClear }) => {
  ...
  return (
    <section className="bg-white rounded-tl-xl rounded-bl-xl">
      <form noValidate className="flex flex-col p-6 gap-4" onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="flex flex-col gap-2 w-full sm:col-span-2">
          <label htmlFor="" className="text-slate-700 text-sm font-semibold">Mortgage Type</label>
        ...
        {/* Submit button */}
        <button type="submit" className="items-center justify-center font-bold rounded-full bg-lime transition-all text-slate-900 w-full sm:max-w-[314px] h-12 hover:contrast-125 flex gap-3">
